  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {/* Translate Button - Between Streak and XP */}
        <TouchableOpacity
          onPress={() => navigation.navigate("OcrTranslate")}
          style={[styles.translateButton, { borderColor: languageColor }]}
        >
          <Ionicons name="camera" size={22} color={languageColor} />
          <Text style={[styles.translateButtonText, { color: languageColor }]}>
            Translate
          </Text>
        </TouchableOpacity>
